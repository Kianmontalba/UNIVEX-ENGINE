...
| 3 | **Material and mesh asset workflow** | Inspector GUID binding and deterministic typed UVE envelope reimport are closed; remaining raw model/texture/material source conversion, fallback diagnostics, Content Browser actions, and previews must be audited before implementation. | Asset-backed mesh/material/texture path is deterministic, editor-visible, failure-safe, and covered by import, renderer, Inspector, and smoke tests. |
