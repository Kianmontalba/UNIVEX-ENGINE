...
| 5 | **Scene components and prefab maturity** | Runtime scene ownership and serialization are authoritative; camera, light, collider, rigid-body, and audio-source component validity plus invalid-scene rollback are now closed bounded foundations. | Remaining mesh/animation/particle/script component contracts, listener/mixer/effects depth, shape/filter breadth, constraints, character depth, editor commands, nested prefabs, overrides, apply/revert, conflict handling, and persistence tests require independent bounded increments. |
