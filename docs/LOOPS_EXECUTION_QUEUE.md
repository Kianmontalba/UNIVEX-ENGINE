...
| 4 | **Core asset-type importers and data table pipeline** | Stable virtual paths, asset identity, derived-data boundaries, and explicit parser/licensing choices; typed UVE envelope copy-register contracts are now a completed foundation. | Raw model, texture, audio, material, animation, shader, and typed CSV/JSON/TSV import contracts are selected and implemented only where fixtures and validation exist. |
