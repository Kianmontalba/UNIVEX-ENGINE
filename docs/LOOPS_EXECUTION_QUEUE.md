...
| 5 | **Scene components and prefab maturity** | Runtime scene ownership and serialization are authoritative; camera and light component validity plus invalid-scene rollback are now closed bounded foundations. | Remaining mesh/collider/rigid-body/audio/animation/particle/script component contracts, editor commands, nested prefabs, overrides, apply/revert, conflict handling, and persistence tests require independent bounded increments. |
