...
|---|---|---|---|
| **COMPLETED / PARTIAL** | [Complete Development Roadmap](EDITOR_ROADMAP.md) | Every completed Increment **1–66**, immediate Scene Editor increments, and the first-generation editor completion gate. | **Increment 67 — Editor Session Settings & Layout v1**. |
