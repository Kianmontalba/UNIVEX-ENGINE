...
|---|---|---|---|
| **COMPLETED / PARTIAL** | [Complete Development Roadmap](EDITOR_ROADMAP.md) | Every completed Increment **1–73**, immediate Scene Editor increments, and the first-generation editor completion gate. | Plan Increment 74 while retaining native C++ renderer/OpenGL ownership and the managed host's explicitly deferred viewport surface boundary; Increment 73 GLSL viewport visuals are completed. |
