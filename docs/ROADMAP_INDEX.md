...
|---|---|---|---|
| **COMPLETED / PARTIAL** | [Complete Development Roadmap](EDITOR_ROADMAP.md) | Every completed Increment **1–68**, immediate Scene Editor increments, and the first-generation editor completion gate. | Select the next scoped milestone from the long-term editor and tooling backlog. |
