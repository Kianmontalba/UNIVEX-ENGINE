...
/// 8-bit grayscale/RGB/indexed/RGBA input through bounded pass reconstruction, validated palette mapping, and opaque-alpha
/// normalization. It rejects unsupported
