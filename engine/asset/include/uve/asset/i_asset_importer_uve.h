...
/// OBJ-to-`.uvemodel`, and MTL-to-`.uvemat` bridges. FBX/glTF/JPEG/WAV and other format-specific
/// conversion remains independently registered through RegisterImporterUVE().
