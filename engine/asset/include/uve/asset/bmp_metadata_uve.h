...
/// Decodes bounded Windows BMP BITMAPINFOHEADER images with 8-bit indexed BGRA palette pixels, 16-bit BI_RGB BGR555, 16-bit BI_BITFIELDS BGR565, 24-bit BGR, or 32-bit BGRA pixels,
