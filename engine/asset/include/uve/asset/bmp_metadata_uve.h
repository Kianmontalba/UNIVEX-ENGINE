...
/// Decodes bounded Windows BMP BITMAPINFOHEADER images with 1/4/8-bit indexed BGRA palette pixels, 4-bit BI_RLE4 or 8-bit BI_RLE8 indexed packets, 16-bit BI_RGB BGR555, exact-mask 16-bit BI_BITFIELDS BGR555/BGR565, exact-mask 32-bit BI_BITFIELDS BGRX or BI_ALPHABITFIELDS BGRA, 24-bit BGR, or 32-bit BGRA pixels,
/// BI_RGB, BI_RLE4, BI_RLE8, the supported BI_BITFIELDS forms, or BI_ALPHABITFIELDS, and bottom-up or top-down rows into copied top-down RGBA8 pixels with source alpha only for the validated BI_ALPHABITFIELDS form.
