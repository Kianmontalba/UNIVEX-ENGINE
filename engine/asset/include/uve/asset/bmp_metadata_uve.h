...
/// Decodes bounded Windows BMP BITMAPINFOHEADER images with 1/4/8-bit indexed BGRA palette pixels, 16-bit BI_RGB BGR555, exact-mask 16-bit BI_BITFIELDS BGR555/BGR565, 24-bit BGR, or 32-bit BGRA pixels,
