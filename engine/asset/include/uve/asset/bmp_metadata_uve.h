...
/// Decodes bounded Windows BMP BITMAPINFOHEADER images with 1/4/8-bit indexed BGRA palette pixels, 16-bit BI_RGB BGR555, exact-mask 16-bit BI_BITFIELDS BGR555/BGR565 or 32-bit BGRX, 24-bit BGR, or 32-bit BGRA pixels,
/// BI_RGB or the supported BI_BITFIELDS form, and bottom-up or top-down rows into copied top-down opaque RGBA8 pixels.
