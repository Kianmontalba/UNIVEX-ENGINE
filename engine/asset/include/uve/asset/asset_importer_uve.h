...
/// envelopes, and bounded raw PNG-to-`.uvetex`, OBJ-to-`.uvemodel`, and MTL-to-`.uvemat` bridges.
/// Envelope imports are deterministic reimport/copy contracts; the source importers decode/convert
/// only their documented bounded forms, while raw FBX/glTF/JPEG, MTL texture/shader resolution, and
/// other texture/audio conversion remains independently deferred.
