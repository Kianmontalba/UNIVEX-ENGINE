...
AssetImporterUVE::AssetImporterUVE() : m_impl(std::make_unique<ImplUVE>()) {
    ...
    // bounded PNG, OBJ, MTL, and glTF/GLB one-primitive source conversions are registered separately;
    // FBX/JPEG/audio and broader glTF scene/material/image conversion remains independent parser-owned work.
