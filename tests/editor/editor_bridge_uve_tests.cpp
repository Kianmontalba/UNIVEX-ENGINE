...
TEST(EditorBridgeUVETest, SnapshotUVE_CopiesHierarchyInspectorAndNativePanelSessionState) {
    ...
    ASSERT_TRUE(engine.Load());
    {
        ...
        ASSERT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds.size(), 53U);
        ASSERT_EQ(snapshot.visualScripting.canvas.paletteDescriptors.size(), 53U);
        ...
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[6], "math.float.add");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[10], "math.float.modulo");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[11], "math.float.abs");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[15], "math.float.power");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[16], "math.vector2.make");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[21], "math.vector2.normalize");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[22], "math.vector3.make");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[29], "math.vector3.normalize");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[33], "logic.boolean.xor");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[34], "logic.boolean.equal");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[35], "logic.boolean.not_equal");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[36], "logic.boolean.greater");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[37], "logic.boolean.less");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[38], "logic.boolean.greater_equal");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[39], "logic.boolean.less_equal");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[40], "query.entity.has_component");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[41], "query.entity.get_component");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[42], "engine.log");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[43], "engine.get_time");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[44], "variable.make_number");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[45], "variable.get_number");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[46], "variable.set_number");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[47], "variable.make_boolean");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[48], "variable.get_boolean");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[49], "variable.set_boolean");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[50], "variable.make_vector3");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[51], "variable.get_vector3");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[52], "variable.set_vector3");
