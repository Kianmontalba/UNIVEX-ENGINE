...
TEST(EditorBridgeUVETest, SnapshotUVE_CopiesHierarchyInspectorAndNativePanelSessionState) {
    ...
    ASSERT_TRUE(engine.Load());
    {
        ...
        ASSERT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds.size(), 81U);
        ASSERT_EQ(snapshot.visualScripting.canvas.paletteDescriptors.size(), 81U);
        ...
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[68], "query.entity.has_component");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[69], "query.entity.get_component");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[70], "engine.log");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[71], "engine.get_time");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[72], "variable.make_number");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[73], "variable.get_number");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[74], "variable.set_number");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[75], "variable.make_boolean");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[76], "variable.get_boolean");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[77], "variable.set_boolean");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[78], "variable.make_vector3");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[79], "variable.get_vector3");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[80], "variable.set_vector3");
