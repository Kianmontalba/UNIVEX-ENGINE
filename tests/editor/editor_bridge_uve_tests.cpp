...
TEST(EditorBridgeUVETest, SnapshotUVE_CopiesHierarchyInspectorAndNativePanelSessionState) {
    ...
    ASSERT_TRUE(engine.Load());
    {
        ...
        ASSERT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds.size(), 92U);
        ASSERT_EQ(snapshot.visualScripting.canvas.paletteDescriptors.size(), 92U);
        ...
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[6], "convert.number_to_boolean");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[7], "convert.boolean_to_number");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[8], "convert.vector2_to_vector3");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[9], "convert.vector3_to_vector2");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[10], "math.float.add");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[14], "math.float.modulo");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[15], "math.float.abs");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[19], "math.float.power");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[20], "math.float.lerp");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[21], "math.float.remap");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[22], "math.float.sin");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[23], "math.float.cos");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[24], "math.float.tan");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[25], "math.float.sqrt");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[26], "math.float.random");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[27], "math.float.random_range");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[28], "math.vector2.make");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[33], "math.vector2.normalize");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[34], "math.vector2.dot");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[35], "math.vector2.distance");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[36], "math.vector2.direction");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[37], "math.vector2.lerp");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[38], "math.vector3.make");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[45], "math.vector3.normalize");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[46], "math.vector3.distance");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[47], "math.vector3.direction");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[48], "math.vector3.lerp");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[49], "math.rotation.make");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[50], "math.rotation.break");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[51], "math.rotation.degrees");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[52], "math.rotation.radians");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[53], "math.rotation.euler");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[54], "math.rotation.quaternion");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[55], "math.rotation.look_at");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[56], "math.rotation.slerp");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[57], "math.rotation.rotate");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[61], "logic.boolean.xor");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[62], "logic.boolean.equal");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[63], "logic.boolean.not_equal");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[64], "logic.boolean.greater");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[65], "logic.boolean.less");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[66], "logic.boolean.greater_equal");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[67], "logic.boolean.less_equal");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[68], "math.transform.make");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[69], "math.transform.break");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[70], "math.transform.get_position");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[71], "math.transform.set_position");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[72], "math.transform.get_rotation");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[73], "math.transform.set_rotation");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[74], "math.transform.get_scale");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[75], "math.transform.set_scale");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[76], "math.transform.translate");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[77], "math.transform.rotate");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[78], "math.transform.transform_point");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[79], "query.entity.has_component");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[80], "query.entity.get_component");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[81], "engine.log");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[82], "engine.get_time");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[83], "variable.make_number");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[84], "variable.get_number");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[85], "variable.set_number");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[86], "variable.make_boolean");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[87], "variable.get_boolean");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[88], "variable.set_boolean");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[89], "variable.make_vector3");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[90], "variable.get_vector3");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[91], "variable.set_vector3");
