...
TEST(EditorBridgeUVETest, SnapshotUVE_CopiesHierarchyInspectorAndNativePanelSessionState) {
    ...
    ASSERT_TRUE(engine.Load());
    {
        ...
        ASSERT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds.size(), 72U);
        ASSERT_EQ(snapshot.visualScripting.canvas.paletteDescriptors.size(), 72U);
        ...
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[52], "logic.boolean.xor");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[53], "logic.boolean.equal");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[54], "logic.boolean.not_equal");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[55], "logic.boolean.greater");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[56], "logic.boolean.less");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[57], "logic.boolean.greater_equal");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[58], "logic.boolean.less_equal");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[59], "query.entity.has_component");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[60], "query.entity.get_component");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[61], "engine.log");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[62], "engine.get_time");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[63], "variable.make_number");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[64], "variable.get_number");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[65], "variable.set_number");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[66], "variable.make_boolean");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[67], "variable.get_boolean");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[68], "variable.set_boolean");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[69], "variable.make_vector3");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[70], "variable.get_vector3");
        EXPECT_EQ(snapshot.visualScripting.canvas.paletteNodeTypeIds[71], "variable.set_vector3");
